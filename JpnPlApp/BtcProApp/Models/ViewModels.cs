...
namespace BtcProApp.Models
{
    ...
    public class PreprocessVM
    {
        public int newJoinings { get; set; }
        public int totalJoinings { get; set; }
        public int royaltyClubMembers { get; set; }
        public int diamondRoyaltyClubMembers { get; set; }
        public double royaltyClubFund { get; set; }
        public double diamondRoyaltyClubFund { get; set; }
        public double RoyaltyShare { get; set; }
        public double DiamondRoyaltyShare { get; set; }
        public string lastProcessDateTime { get; set; }
    }
